...
<body>
	...
	<form action="11.중간체크2.jsp" method="get">
		...
		for (int i = 0; i <= 6; i += 3) {
			...
			if (!게임판[i].equals(" ") && 게임판[i].equals("O")) {
		    // ! : 부정 [ true => false ]
		    out.print("Winner : Player!!");
			} else if (!게임판[i].equals(" ") && 게임판[i].equals("X")) {
		    out.print("Winner : Computer!!");
			}
		    }
		}
		...
		if (게임판[0].equals(게임판[4]) && 게임판[4].equals(게임판[8])) {
		    if (!게임판[0].equals(" ") && 게임판[0].equals("O")) {
			// ! : 부정 [ true => false ]
			out.print("Winner : Player!!");
		    } else if (!게임판[0].equals(" ") && 게임판[0].equals("X")) {
			out.print("Winner : Computer!!");
		    }
		}
		if (게임판[2].equals(게임판[4]) && 게임판[4].equals(게임판[6])) {
		    if (!게임판[2].equals(" ") && 게임판[2].equals("O")) {
			// ! : 부정 [ true => false ]
			out.print("Winner : Player!!");
		    } else if (!게임판[2].equals(" ") && 게임판[2].equals("X")) {
			out.print("Winner : Computer!!");
		    }
		}
		%>
