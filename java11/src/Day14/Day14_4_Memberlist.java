...
public class Day14_4_Memberlist {
	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream fileInputStream = 
				new FileInputStream("C:/Users/ez201208/git/ezen-education/java11/src/Day14/userlist.txt");
					...
					// 4. 파일처리 
						...
						try {	
							FileOutputStream fileOutputStream = 
								new FileOutputStream("C:/Users/ez201208/git/ezen-education/java11/src/Day14/userlist.txt" , true );
						...
						while(true) { // 회원메뉴 무한루프
							...
							if( ch2 == 1) {
								...
								try {
									// 0. 파일출력 객체 생성 ( 파일경로 )
									FileOutputStream fileOutputStream = 
											new FileOutputStream("C:/Users/ez201208/git/ezen-education/java11/src/Day14/userlist.txt");
