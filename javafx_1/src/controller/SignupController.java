...
public class SignupController {
    ...
    void signup(ActionEvent event) {
    	...
    	// 5. 메세지창 띄우고 페이지 전환
    	Alert alert = new Alert(AlertType.INFORMATION); // 1.메세지 객체 생성
    	alert.setContentText("Nike community 가입을 축하합니다 [포인트 1000 지급]"); // 2.메세지 내용
    	alert.setHeaderText("회원가입 성공"); // 3.메세지 제목
    	alert.setTitle("알림");
    	alert.showAndWait(); // 4. 메세지창 띄우고 버튼 입력시까지 대기
